...
values (
  ...
  $$We have six core packages on file: Vrly Content Engine (anchor product, fulfilled by Axiolo), Ads Management (Logan Boyce), AI Audit (entry point, Axiolo-led), AI Assistant (vendor TBD), Social Media Management (fulfilled by Axiolo, phasing toward Content Engine), and Crowdfunding Platform (fulfillment vendor TBD).$$,
...
values (
  ...
  $$We have the CMO role at Vrly currently performed by you, with Axiolo providing fractional strategy. The role covers vendor and fulfillment oversight, content manager coordination with Logan, client communication and retention, package strategy and margin management, marketing for Vrly itself, and GLC ecosystem alignment. Rebecca's Operations Team handles back of house only.$$,
